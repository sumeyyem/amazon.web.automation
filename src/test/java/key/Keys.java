...
public class Keys {
    ...
    public static final String ADDRESS = "Yakacik Yeni Mah Karanfil Sok No:10/12 Kartal/Istanbul";
    public static final String ISTANBUL = "Istanbul";
    public static final String KARTAL = "Kartal";
    public static final String ZIP_CODE = "34860";
    public static final String PHONE_NUMBER = "5990001122";
}
